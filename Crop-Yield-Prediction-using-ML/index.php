...
<body>
    ...
    <div class="page" id="part1">
        <div class="info">
            <div class="heading">
                <div class="title text-primary">Crop Yield Forecasting</div>
    ...
    <div class="page" id="part2">
        ...
        <div class="card myCard">
            ...
            <div class="myCard-body ">A Random Forest ML model, trained on years of data, is used to predict the approximate crop yield</div>
        </div>
        <div class="scrollIndicator"></div>
    </div>
        ...
        <div class="card shadow-lg col-6 p-0 mx-auto">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control" name="county" id="district"></select>
                </div>
                <div class="form-group">
